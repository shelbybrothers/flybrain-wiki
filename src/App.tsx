  ...
  return <div className={`app text-${size}`}>
    ...
    <div className="page-shell">
      <aside className="contents-sidebar">
        <span className="sidebar-edition">A LIVING EXPERIMENT <span>v0.2</span></span>
